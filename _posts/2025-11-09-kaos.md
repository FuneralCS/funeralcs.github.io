...
1. [Chaos computing Wikipedia][1]
2. [Chaos theory Wikipedia][2]
3. [Chaos computing an introduction][3]
4.  [What is Chaos Computing and Why We Should Care About It][4]
5. [Applications of Chaos Theory][5]
6. [Nathan Holt Chaotic Cryptography: Applications of Chaos Theory to Cryptography][6]
7.  [Implementation and practical problems of chaos-based cryptography revisited][7]
8. [Chaos-Based Image Encryption: Review, Application, and Challenges][8]
